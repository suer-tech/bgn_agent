...
This repository contains sample agents for the [BitGN Platform](https://bitgn.com). Sample agents use SDKs that are audo-generated from the [BitGN Schema](https://buf.build/bitgn/api) that is located in [proto/](proto/) folder.
